...
class TestDay14(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.example = input_data("year_2023/day_14_parabolic_reflector_dish/example.txt")
        cls.puzzle_input = input_data("year_2023/day_14_parabolic_reflector_dish/input.txt")
